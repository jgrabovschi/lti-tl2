...
<div class="flex justify-center mt-6">
    <div class="block p-6 w-full max-w-3xl bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="font-normal text-gray-700 dark:text-gray-400">If you refresh or leave the page, the chat will be lost.</p>
    </div>
</div>
...
<script type="module">
    ...
    function renderMessages() {
        ...
        chat.forEach(function(message) {
            ...
            //messageDiv.className = 'p-4 bg-gray-100 dark:bg-gray-800 rounded-lg';
    ...
    function gemini() {
        ...
        if (userMessage) {
            ...
            var result = axios.post('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=' + key, {
                "systemInstruction": {
                "parts": [
