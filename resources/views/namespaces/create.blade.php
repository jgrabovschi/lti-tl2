...
<div class="flex justify-center">
    <div class="block p-6  w-md bg-white border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">New Namespace</h5>
        <p class="font-normal text-gray-700 dark:text-gray-400">Here you will create a new namespace in the cluster.</p>
    
    </div>
</div>
<form method="GET" action="{{ route('showNamespaces') }}">
...
<div class="w-full md:w-1/2 lg:w-1/3 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
    ...
    @enderror
    <form method="POST" class="max-w-sm mx-auto" action="{{ route('storeNamespace') }}">
        @csrf
        @method('PUT')
        <div class="mb-5">
